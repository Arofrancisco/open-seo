...
# PlanetaSEO Competitor Analysis
...
7. **How this report was made** — opens with the skill link line from `seo-report`, pointing at `https://github.com/Arofrancisco/open-seo/blob/main/.agents/skills/competitor-analysis/SKILL.md` ("PlanetaSEO Competitor Analysis skill"), then which tools reported what, and what you checked yourself.
