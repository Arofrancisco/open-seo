...
# PlanetaSEO Competitive Landscape
...
6. **How this report was made** — opens with the skill link line from `seo-report`, pointing at `https://github.com/Arofrancisco/open-seo/blob/main/.agents/skills/competitive-landscape/SKILL.md` ("PlanetaSEO Competitive Landscape skill"), then the query set used, and a note calling the read directional when the query set was small.

## Guardrails

- Distinguish SEO competitors from business competitors.
- Do not overstate exact traffic when PlanetaSEO returns estimates.
