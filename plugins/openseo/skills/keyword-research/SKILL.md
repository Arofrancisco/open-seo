...
# PlanetaSEO Keyword Research

## Goal

Turn seed topics into a prioritized keyword opportunity set using PlanetaSEO MCP data. The output should help the user decide what to target, what to save, and what to research next.
...
7. **How this report was made** — opens with the skill link line from `seo-report`, pointing at `https://github.com/Arofrancisco/open-seo/blob/main/.agents/skills/keyword-research/SKILL.md` ("PlanetaSEO Keyword Research skill"), then which tools returned what.

## Guardrails

- Do not invent metrics. If PlanetaSEO does not return a value, write `unknown`.
