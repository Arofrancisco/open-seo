...
6. **How this report was made** — opens with the skill link line from `seo-report`, pointing at `https://github.com/Arofrancisco/open-seo/blob/main/.agents/skills/keyword-clustering/SKILL.md` ("PlanetaSEO Keyword Clustering skill"), then where the keywords came from, and a note labelling target pages as proposed when no URL data was supplied.
